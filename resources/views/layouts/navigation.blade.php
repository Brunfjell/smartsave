            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('smartsave-logo.png') }}" class="block h-9 w-auto" alt="Smart Save Logo" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('analytics')" :active="request()->routeIs('analytics')" class="border-b-2 ">
                        {{ __('Analytics') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('devices')" :active="request()->routeIs('devices')" class="border-b-2 ">
                        {{ __('Devices') }}
                    </x-nav-link>
                </div>
            </div>
